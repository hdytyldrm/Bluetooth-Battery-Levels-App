...
import com.demo.bluetoothbatterylevel.ads.CounterManager;
import com.demo.bluetoothbatterylevel.ads.UnifiedInterstitialAdManager;
...
import com.demo.bluetoothbatterylevel.utils.AboutBottomSheetFragment;
import com.demo.bluetoothbatterylevel.utils.BaseActivity;
...
public class StartActivityYeni extends BaseActivity {
    ...
    private void requestCurrentBatteryStatus() {
        ...
        Intent intent = new Intent("com.demo.bluetoothbatterylevel.REQUEST_BATTERY_STATUS");
